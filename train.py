...
if __name__ == '__main__':
    ...
    model = DenseNet201(n_class=15, epochs=1, batch_size=10)
    ...
    model = SqueezeNet(n_class=15, epochs=1, batch_size=10)
    model.train(dir='train_data', pkl_file='train_paths_features_labels.pkl')
    model.evaluate_model(dir='train_data', pkl_file='test_paths_features_labels.pkl')

    model = ResNet152(n_class=15, epochs=1, batch_size=10)
    model.train(dir='train_data', pkl_file='train_paths_features_labels.pkl')
    model.evaluate_model(dir='train_data', pkl_file='test_paths_features_labels.pkl')
